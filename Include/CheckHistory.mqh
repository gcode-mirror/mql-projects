...
#property version   "2013.02.18"

#define MAX_WAITING_TIME	30000		// ћаксимальное врем€ ожидани€ подкачки истории
...
//--- don't ask for load of its own data if it is an indicator
   ...
   Print(symbol,", ",EnumToString(period),": ERROR synchronizing history!!!");
