...
int OnInit()
  {
   ...
   fileHandle = FileOpen("FLAT_STAT_SECOND/FLAT_C_" + _Symbol+"_" + PeriodToString(_Period) + ".txt", FILE_WRITE|FILE_COMMON|FILE_ANSI|FILE_TXT, "");
...
void SaveStatToFile ()
 { 
  FileWriteString(fileHandle,"Статистика по флэту типа C: " + _Symbol + "\n");
