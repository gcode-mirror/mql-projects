          ...
          if (curLocLevel4 == LOCATION_INSIDE) 
            ...
            {   
             if (curLocLevel4 == LOCATION_ABOVE && prevLocLevel4 == LOCATION_BELOW)
               {
                countDownUp ++;
                if (countBarsInsideLevel4 > 4)  // если бары находились внутри уровня. то уровень сработавший
                 countDone ++;
                else
                 countUnDone ++;
          ...
          if (curLocLevel3 == LOCATION_INSIDE) 
            ...
            {   
             if (curLocLevel3 == LOCATION_ABOVE && prevLocLevel3 == LOCATION_BELOW)
                {
                 countDownUp ++;
                if (countBarsInsideLevel3 > 4)  // если бары находились внутри уровня. то уровень сработавший
                 countDone ++;
                else
                 countUnDone ++;  
