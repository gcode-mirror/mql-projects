...
//+------------------------------------------------------------------+
//| param func: string - function called name                        |
//| returns string formated <PROGRAM_NAME>_<SYMBOL>(<TF>)_<FUNCTION> |
//+------------------------------------------------------------------+
string MakeFunctionPrefix(string func)
{
 return(StringFormat("=> %s_%s(%s)_%s::",MQL5InfoString(MQL5_PROGRAM_NAME),StringSubstr(_Symbol,0,6),PeriodToString(_Period),func));
}
