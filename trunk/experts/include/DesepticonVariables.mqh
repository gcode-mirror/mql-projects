...
extern int MinProfit_5M = 300; // когда профит достигает указанное количество пунктов, трейлинг начинает работу
extern int TrailingStop_5M_min = 300; // Величина трала
extern int TrailingStop_5M_max = 300; // Величина трала
extern int TrailingStep_5M = 100; // Величина шага

extern int MinProfit_1H = 300; // когда профит достигает указанное количество пунктов, трейлинг начинает работу
extern int TrailingStop_1H_min = 300; // Величина трала
extern int TrailingStop_1H_max = 300; // Величина трала
extern int TrailingStep_1H = 100; // Величина шага

extern int MinProfit_1D = 300; // когда профит достигает указанное количество пунктов, трейлинг начинает работу
extern int TrailingStop_1D_min = 300; // Величина трала
extern int TrailingStop_1D_max = 300; // Величина трала
extern int TrailingStep_1D = 100; // Величина шага
...
// переменныые для старых роботов
double minPrice;
double maxPrice;
