...
input int kPeriod = 5;          // К-период Stochastic
input int dPeriod = 3;          // D-период Stochastic
input int slow  = 3;            // Сглаживание графика. Возможные значения от 1 до 3. Stochastic
input int top_level = 80;       // top уровень Stochastic
input int bottom_level = 20;    // bottom уровень Stochastic
