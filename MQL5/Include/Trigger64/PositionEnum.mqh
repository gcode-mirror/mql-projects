...
//+------------------------------------------------------------------+
//| структура хранения свойств позиций                               |
//+------------------------------------------------------------------+  
struct position_properties  //поменять использование этой структуры на использование класса PositionOnPendingOrders
  {
