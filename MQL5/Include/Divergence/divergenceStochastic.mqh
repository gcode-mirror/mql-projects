...
int divergenceSTOC(int handleSTOC, const string symbol, ENUM_TIMEFRAMES timeframe, int top_level, int bottom_level,int DEPTH_STOC,int ALLOW_DEPTH_FOR_PRICE_EXTR, PointDivSTOC& div_point, int startIndex = 0,bool LOG = false)
{
 double iSTOC_buf[];                         
 double iHigh_buf[];
 double iLow_buf[];
