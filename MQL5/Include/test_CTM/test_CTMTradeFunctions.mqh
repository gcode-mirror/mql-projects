...
//+------------------------------------------------------------------+
class test_CTMTradeFunctions : public CTrade
{
 public:
...
//| Удаление отложника                                               |
//+------------------------------------------------------------------+
bool test_CTMTradeFunctions::OrderDelete(ulong ticket)
{
  int i = 0;
  int tryNumber = 5;
  bool res = false;
...
//+-------------------------------------------------------------------------+
bool test_CTMTradeFunctions::PositionClose(const string symbol, const ENUM_POSITION_TYPE type, const double volume, const ulong deviation=ULONG_MAX)
{
 int tryNumber = 5;
