...
void OnChartEvent(const int id,         // идентификатор события  
      ...
      if (mode == 0)
       {
        extr = 1;
        // если сейчас флэт 
        if ( IsFlatA(extr_container.GetFormedExtrByIndex(0,EXTR_HIGH),extr_container.GetFormedExtrByIndex(1,EXTR_HIGH),
 ...
 int IsFlatA (CExtremum *high0,CExtremum *high1,CExtremum *low0, CExtremum *low1)  // флэт А  
 {
