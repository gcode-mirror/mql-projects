...
int OnInit()
  {
   ...
   fileHandle = FileOpen("FLAT_STAT/FLAT_G_" + _Symbol+"_" + PeriodToString(_Period) + ".txt", FILE_WRITE|FILE_COMMON|FILE_ANSI|FILE_TXT, "");
...
int IsFlatG (CExtremum *high0,CExtremum *high1,CExtremum *low0, CExtremum *low1) // флэт G
 {
...
void SaveStatToFile ()
 { 
  FileWriteString(fileHandle,"Статистика по флэту типа G: " + _Symbol + "\n");
