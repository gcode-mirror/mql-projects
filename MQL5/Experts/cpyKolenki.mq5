...
void OnDeinit(const int reason)
  {
   delete ctm;
   Print("Из них достигли обоих линий: ",YesTrendYesHor);   
   Print("Из них достигли горизонтальной, но не тренда: ",NoTrendYesHor);
   Print("Из них достигли тренда, но не горизонтальной: ",YesTrendNoHor);   
   Print("Из них не достигли линий: ",NoTrendNoHor);
   Print("Количество экстремумов: ",countTotal);  
